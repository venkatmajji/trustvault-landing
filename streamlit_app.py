...
.cta-button {font-size: 20px; padding: 14px; background-color:white; color: black; border-radius: 8px; text-align: center; display: block; margin: 10px auto; text-decoration: none;}
.cta-button:hover {background-color: white;}
@keyframes fadeIn {
  0% {opacity:0;}
  100% {opacity:1;}
}
